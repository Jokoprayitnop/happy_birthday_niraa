...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('January 25, 2023 00:00:00').getTime(),
...
const _slideDua = function () {
  const slideSatu = document.getElementById('slideSatu');
  const tap = document.getElementById('tap', music);
...
new TypeIt("#teks1", {
  strings: ["Sebentar lagi kamu akan memulai tahun baru dalam hidupmu", " ", "Aku harap tahun yang akan datang ini akan membawa setiap kesuksesan yang layak kamu dapatkan.", " ", "Terima kasih karena telah menambah keceriaan dalam kehidupanku."," ", "Harapanku dan mimpi kukirimkan kepadamu.", " ", "Terima kasih karena telah menambah keceriaan dalam kehidupanku.", " ", "Harapanku dan mimpi kukirimkan kepadamu."],
  startDelay: 4000,
  speed: 100,
...
new TypeIt("#teks2", {
  strings: ["Semoga semuanya baik-baik saja.", " ", "Semua yang kamu harapankan dikabulkan di kemudian hari.", " ", "SELAMAT ULANG TAHUN ARI NIRA FITRIANNA 🙂"],
  startDelay: 2000,
  speed: 100,
  waitUntilVisible: true
}).go();
